            ...
            <div className="space-y-2">
              ...
              <div className="pt-3">
                ...
                <div className="mt-3 flex items-center gap-2">
                  <Label htmlFor="baseTemp">Base temp (°C)</Label>
                  <Input id="baseTemp" type="number" value={baseTemp} onChange={(e) => setBaseTemp(Number(e.target.value))} className="w-24" />
                  <Label htmlFor="avgTemp">Avg daily temp override (°C)</Label>
                  <Input id="avgTemp" type="number" value={avgTempOverride ?? ''} onChange={(e) => setAvgTempOverride(e.target.value ? Number(e.target.value) : null)} className="w-24" />
                </div>
              </div>
              <div className="pt-3">
